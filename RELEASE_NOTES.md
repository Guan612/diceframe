...
这是 2.0 系列的正式更新，自 v2.0.0 以来专注优化手机端对局体验。
...
A stable update in the 2.0 series, focused on the mobile play experience since v2.0.0.

### v2.0.1 Update · Mobile Play Experience

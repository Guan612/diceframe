...
export const MODEL_ROUTING_CONFIG_KEYS = [
  ...
  'imagegen_enabled', 'imagegen_auto_scene', 'imagegen_manual_scene', 'imagegen_auto_storyboard', 'imagegen_auto_use_manual_prompt', 'imagegen_provider_ref', 'imagegen_model',

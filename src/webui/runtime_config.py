    ...
    def load(self) -> RuntimeConfig:
        ...
        state: dict[str, Any] = {
            ...
            **{
            ...
            "imagegen_auto_storyboard": bool(saved.get("imagegen_auto_storyboard", False)),
            "imagegen_auto_use_manual_prompt": bool(saved.get("imagegen_auto_use_manual_prompt", True)),

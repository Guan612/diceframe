    ...
    *,
    ...
    return localized_text(language, {
        "en": (
            ...
            f"2. Describe an action: {command_example('I inspect the area', command_prefix=command_prefix)}\n"
            f"   Ask the GM without acting: {command_example('ask <question>', command_prefix=command_prefix)}\n"
        ...
        "ja": (
            ...
            f"   行動せず GM に質問：{command_example('ask <question>', command_prefix=command_prefix)}\n"
